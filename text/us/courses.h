COURSE_ACTS(COURSE_BOB, _(" 1 MASSIVE MUSHROOM VALLEY"),
       _("THE MYSTERIOUS CAVERN")         , _("FUNGAL REDS")                   , _("A FAMILY RECIPE"),
       _("ATOP THE GIANT MUSHROOM -WC-")  , _("HIDDEN IN PLAIN SIGHT")         , _("UNOBTAINABLE"))
...
COURSE_ACTS(COURSE_HMC, _(" 6 SUGAR SWEET ISLES"),
       _("THE FLOATING GRAHAM CRACKERS")  , _("CLIMB UP THE CAKES")            , _("MILK AND COOKIES"),
       _("SUPER SLIPPERY ICE CREAM")      , _("FOLLOW THE JELLY TRAIL")        , _("UNOBTAINABLE"))
...
COURSE_ACTS(COURSE_SL, _("10 CHILLED OUT LAKE"),
       _("SPAR WITH CHIEF CHILLY")        , _("A CASE OF FREEZE BURN -MC-")    , _("SHELL SHREDDIN' ON RAMPS"),
       _("A SLIDE AND A WHIRL")           , _("TAKING THE LONG WAY")           , _("UNOBTAINABLE"))

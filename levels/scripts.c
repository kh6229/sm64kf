...
const LevelScript script_func_global_4[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_BROWN_MUSHROOM, brown_mushroom_geo),
...
const LevelScript script_func_global_7[] = {
    LOAD_MODEL_FROM_GEO(MODEL_GUMMY_GOOMBA, gummy_goomba_geo),
    LOAD_MODEL_FROM_GEO(MODEL_OREO, oreo_geo),
...
const LevelScript script_func_global_9[] = {
    LOAD_MODEL_FROM_GEO(MODEL_SECRET_RING, secret_ring_geo),

...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_KOOPA_WITH_SHELL, 3877, 2989, -446, 0, 0, 0, 0x00000000, bhvKoopa),
	...
	AREA(2, bob_area_2),
		...
		OBJECT(MODEL_NONE, 0, 0, -600, 0, 0, 0, (0x16 << 24) | (0x01 << 16), bhvWarp),
		OBJECT(MODEL_BLUE_MUSHROOM, 0, -1109, 2952, 0, 0, 0, 0x00000000, bhvBlueMushroom),
		OBJECT(MODEL_NONE, 0, 0, -228, 0, 0, 0, (0x0A << 16), bhvSpinAirborneWarp),

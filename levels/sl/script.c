...
const LevelScript level_sl_entry[] = {
	...
	AREA(1, sl_area_1),
		...
		OBJECT(MODEL_CHILL_BULLY, 7356, 2300, -5244, 0, 0, 0, 0x00000000, bhvSmallChillBully),
		OBJECT(MODEL_CHILL_BULLY, 6634, 2300, -4528, 0, 0, 0, 0x00000000, bhvSmallChillBully),
		OBJECT(MODEL_CHILL_BULLY, 12816, 2116, -1682, 0, 0, 0, 0x00000000, bhvSmallChillBully),
		OBJECT(MODEL_NONE, -10408, 3025, -4719, 0, -22, 0, (COIN_FORMATION_BP_SHAPE_ARROW << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, 8732, 2725, -4132, 0, 90, 0, (COIN_FORMATION_BP_SHAPE_ARROW << 16), bhvCoinFormation),
		...
		OBJECT_WITH_ACTS(MODEL_NONE, 5555, 2907, -7720, 0, 0, 0, (COIN_FORMATION_BP_SHAPE_VERTICAL_LINE << 16), bhvCoinFormation, ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
		...
		OBJECT(MODEL_NONE, 10978, 2641, -503, 0, 0, 0, (COIN_FORMATION_BP_SHAPE_HORIZONTAL_RING << 16), bhvCoinFormation),
		...
		OBJECT(MODEL_YELLOW_COIN, 4642, 810, -6820, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 5285, 810, -8371, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 6836, 810, -7729, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 6194, 810, -6177, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 9971, 1656, -4140, 0, 0, 0, 0x00000000, bhvOneCoin),
		...
		OBJECT(MODEL_HEART, 9853, 4343, -5246, 0, 0, 0, (EXCLAMATION_BOX_BP_METAL_CAP << 16), bhvRecoveryHeart),
		...
		OBJECT(MODEL_RED_COIN, 2496, 869, -227, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 4763, 869, -1862, 0, 0, 0, 0x00000000, bhvRedCoin),
		...
		OBJECT(MODEL_RED_COIN, 1592, 869, -3905, 0, 0, 0, 0x00000000, bhvRedCoin),
		...
		OBJECT(MODEL_SPINDRIFT, -5623, 3109, -7224, 0, 0, 0, (0x01 << 16), bhvSpindrift),
		OBJECT(MODEL_SPINDRIFT, -12079, 2925, 1129, 0, 0, 0, (0x01 << 16), bhvSpindrift),
		OBJECT(MODEL_SPINDRIFT, -759, 3109, -7224, 0, 0, 0, (0x01 << 16), bhvSpindrift),
		OBJECT(MODEL_SPINDRIFT, 11500, 4240, -119, 0, 0, 0, (0x01 << 16), bhvSpindrift),
		OBJECT(MODEL_SPINDRIFT, 9856, 4079, -4058, 0, 0, 0, (0x01 << 16), bhvSpindrift),
		OBJECT(MODEL_STAR, 7854, 3849, 4586, 0, 0, 0, (0x01 << 24), bhvStar),
		OBJECT(MODEL_STAR, -12358, 4227, 3597, 0, 0, 0, (0x03 << 24), bhvStar),
		OBJECT(MODEL_STAR, 13816, 4543, -9554, 0, 0, 0, (0x04 << 24), bhvStar),
		OBJECT(MODEL_NONE, 0, 280, 0, 0, -180, 0, (0x0A << 16), bhvSpinAirborneWarp),

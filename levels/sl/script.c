...
const LevelScript level_sl_entry[] = {
	...
	AREA(1, sl_area_1),
		...
		OBJECT(MODEL_BIG_CHILL_BULLY, 5739, 1409, -7274, 0, -90, 0, 0x00000000, bhvChiefChilly),
		OBJECT(MODEL_CHILL_BULLY, -2499, 1230, -8968, 0, 0, 0, 0x00000000, bhvSmallChillBully),
		OBJECT(MODEL_YELLOW_COIN, 6903, 926, -6111, 0, 0, 0, 0x00000000, bhvOneCoin),
		...
		OBJECT(MODEL_YELLOW_COIN, 5739, 926, -5629, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 4576, 926, -6111, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 4094, 926, -7274, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 4576, 926, -8438, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 5739, 926, -8919, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 6903, 926, -8438, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 7385, 926, -7274, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_ICE_WALL, 5285, 1410, -6177, 0, -23, 0, (0x01 << 16), bhvIceWall),
		OBJECT(MODEL_ICE_WALL, 4642, 1410, -6820, 0, -68, 0, 0x00000000, bhvIceWall),
		OBJECT(MODEL_ICE_WALL, 5285, 1410, -8371, 0, -158, 0, 0x00000000, bhvIceWall),
		OBJECT(MODEL_ICE_WALL, 4642, 1410, -7729, 0, -113, 0, (0x01 << 16), bhvIceWall),
		OBJECT(MODEL_ICE_WALL, 6194, 1410, -8371, 0, 157, 0, (0x01 << 16), bhvIceWall),
		OBJECT(MODEL_ICE_WALL, 6836, 1410, -6820, 0, 67, 0, (0x01 << 16), bhvIceWall),
		OBJECT(MODEL_ICE_WALL, 6194, 1410, -6177, 0, 22, 0, 0x00000000, bhvIceWall),
		OBJECT(MODEL_ICE_WALL, 6836, 1410, -7729, 0, 112, 0, 0x00000000, bhvIceWall),
